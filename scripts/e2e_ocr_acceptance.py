...
EXPECTED_VERSION = os.getenv("OCR_EXPECTED_WORKFLOW_VERSION", "0.4.0")
...
MAX_FINAL_DIFFS = int(os.getenv("OCR_MAX_FINAL_DIFFS", "50"))
...
def main() -> None:
    ...
    assert result["conclusion"] in {"PASS", "REVIEW_REQUIRED"}
